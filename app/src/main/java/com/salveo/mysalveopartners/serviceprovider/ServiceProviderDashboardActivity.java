...
import com.salveo.mysalveopartners.fragmentserviceprovider.FragmentSPDashboard;
import com.salveo.mysalveopartners.fragmentserviceprovider.SPCommunityFragment;
import com.salveo.mysalveopartners.fragmentserviceprovider.SPShopFragment;
...
//                bottom_navigation_view.getMenu().findItem(R.id.community).setChecked(true);
                ...
                startActivity(new Intent(ServiceProviderDashboardActivity.this, SPProfileScreenActivity.class));
            }
        }
        else{
//            bottom_navigation_view.getMenu().findItem(R.id.home).setChecked(true);
